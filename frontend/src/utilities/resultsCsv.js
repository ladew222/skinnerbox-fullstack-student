...
const CSV_COLUMNS = [
  ...
  { key: 'validLeverPressCount', label: 'valid_lever_press_count' },
  { key: 'invalidLeverPressCount', label: 'invalid_lever_press_count' },
  { key: 'nosePokeCount', label: 'nose_poke_count' },
  { key: 'validNosePokeCount', label: 'valid_nose_poke_count' },
  { key: 'invalidNosePokeCount', label: 'invalid_nose_poke_count' },
...
const EVENT_TIMELINE_COLUMNS = [
  ...
  { key: 'responseValidity', label: 'response_validity' },
  { key: 'responseReason', label: 'response_reason' },
  ...
  const rows = normalizedEvents.map((event, index) =>
    EVENT_TIMELINE_COLUMNS.map((column) => {
      const record = {
        ...
        responseValidity: event?.responseValidity || '',
