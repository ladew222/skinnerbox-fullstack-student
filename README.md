...
### 1. **Corrected Backend Port**
- **Old:** 5000
- **New:** **5001 on host**
- Explained container vs host port mapping explicitly

### 2. **Clear DEV vs PI Commands**
- Explicit `docker compose up --build`
- Explicit Pi override usage

### 3. **Requirements Files Explained**
- Students told *not to touch them*
- Clear purpose per file

### 4. **Frontend/Backend Relationship Clarified**
- Students now understand frontend talks to backend on 5001
- Matches your working compose file

### 5. **Removed Redundancy**
- Simulation section unified
- Fewer repeated explanations
- Cleaner flow

### 6. **Student-Proof Language**
- Clear “do this / don’t do this”
- Strong mental model framing
- Fewer ambiguous instructions

---

If you want next, I can:
- add a **1-page “first 10 minutes” quick start**
- add a **TA debugging checklist**
